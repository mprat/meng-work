...
% imgData_path = '/data/vision/torralba/cityimage/data/image_crop/';
% metaData_path = '/data/vision/torralba/cityimage/data/image_gps/';
...
for i=1:nImgs
    imageList{i} = [imgData_path curCity '_crop/' curMetaData.images(i).name];
end
...
[featureSet, scoreSet] = extractDeepFeature(imageList_small); % the input is image path, the number of images should be no smaller than 256 (you could duplicate one image to 256)
