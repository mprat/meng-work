...
if( opts.multiscale )
  ...
  E=E(1+r:siz(1)+r,1+r:siz(2)+r,:)*t; E=dollar_toolbox.channels.convTri(E,1);
end

% compute approximate orientation O from edges E
if( opts.nms==-1 ), O=[]; elseif( nargout>1 || opts.nms )
  [Ox,Oy]=dollar_toolbox.channels.gradient2(dollar_toolbox.channels.convTri(E,4));
  [Oxx,~]=dollar_toolbox.channels.gradient2(Ox); [Oxy,Oyy]=dollar_toolbox.channels.gradient2(Oy);
