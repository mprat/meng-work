...
function features = features_from_list_of_image_paths(list_image_paths, place_to_save_features)
	...
	[features, scoreSet] = extractDeepFeatures(list_trans); % the input is image path, the number of images should be no smaller than 256 (you could duplicate one image to 256)
