...
if(nargout<=1), M=dollar_toolbox.channels.private.gradientMex('gradientMag',I,channel,full);
else [M,O]=dollar_toolbox.channels.private.gradientMex('gradientMag',I,channel,full); end

if( normRad==0 ), return; end; S = dollar_toolbox.channels.convTri( M, normRad );
dollar_toolbox.channels.private.gradientMex('gradientMagNorm',M,S,normConst); % operates on M
